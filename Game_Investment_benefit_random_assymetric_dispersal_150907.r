...
outDir <- "E:/Projects/seq_genetics/analysis/collaboration_paper/3_game theory/outputs/Random dispersal Rates/"
...
#Dispersal rates Z
	...
	#betadist <- sapply(1:6, function(x) rbeta(10000, 0.5,0.5)*50/600) #beta distribution #%of popn
